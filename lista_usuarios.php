<?php
include('menu.php');
include('functions/listar_usuarios.php');
...
<div class="conteudo">
	...
	<div class="col-md-8 offset-md-2 cadastro">
		<p><a href="cadastro_usuario.php"><img class="icone" src="assets/images/novo.png">Cadastrar novo usuário</a></p>
	</div>
		...
		<table class="table col-md-8 offset-md-2">
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <td><a href="edicao_usuario.php?cod=<?php echo $value['codigo'] ?>"><img class="icone" src="assets/images/editar.png"></a></td>
...
function deleteItem(id) {
	$.ajax({
		method: "POST",
		dataType : "html",
		url: "functions/excluir_usuario.php",
		data: { 'codigo': id },
